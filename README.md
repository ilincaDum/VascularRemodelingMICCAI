# Pulmonary Vessel Damage Prediction (Graph-Based)
...
- Wilcoxon signed-rank to identify significant differences in vascular features (e.g., volume, tortuosity) across artery and vein data
