...
This repository contains the core scripts used in the project pipeline for analyzing and predicting longitudinal pulmonary vasculature injury (arteries/veins) following radiotherapy 
...
3. **VesselVio graph creation & annotation**: skeletonize vessels, create graphs, sample dose along vessel segments, encode anatomy/dose (open source script can be found here: https://github.com/JacobBumgarner/VesselVio) 
